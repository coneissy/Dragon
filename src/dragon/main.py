...
async def _run(cfg: Config):
    ...
    try:
        ...
        symbols = _top_symbols(ticker, cfg.max_ws_symbols)
        ...
        if cfg.live_trading and not cfg.dry_run:
            try:
                ...
                _state(binance_authenticated=True, free_usdt=float(last_balance), balance_refreshes=1)
